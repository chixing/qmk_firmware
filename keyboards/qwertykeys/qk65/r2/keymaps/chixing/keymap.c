...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_65_ansi_blocker(
        ...
        KC_LSFT,        LCTL_T(KC_Z),  LSFT_T(KC_X),  LALT_T(KC_C), LGUI_T(KC_V),  LT(_FN, KC_B), KC_N,        LGUI_T(KC_M), LALT_T(KC_COMM), LSFT_T(KC_DOT), LCTL_T(KC_SLSH), KC_RSFT, KC_UP,   KC_VOLD,
        KC_LCTL,        KC_LGUI,       KC_LALT,                     KC_SPC,                        KC_HYPR,     KC_MEH,                                                         KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_FN] = LAYOUT_65_ansi_blocker(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F4,   KC_F5,   KC_F6,   KC_F11,  KC_TRNS,          KC_TRNS, KC_BRIU,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F12,  KC_TRNS,          KC_TRNS, KC_BRID,
